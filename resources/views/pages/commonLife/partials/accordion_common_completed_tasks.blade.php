<div data-accordion="true">
    <div class="accordion-item [&:not(:last-child)]:border-b border-b-gray-200" data-accordion-item="true" id="accordion_item_common_completed_tasks">
        <button class="accordion-toggle py-4 group" data-accordion-toggle="#accordion_content_common_completed_tasks">
        ...
        <div class="accordion-content hidden" id="accordion_content_common_completed_tasks">
